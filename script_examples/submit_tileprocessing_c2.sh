...
python3 $pycold_path/src/python/pycold/imagetool/tile_processing.py --rank=$SLURM_ARRAY_TASK_ID --n_cores=$SLURM_ARRAY_TASK_MAX --result_path=$result_path --stack_path=$stack_path --yaml_path=$yaml_path --method='OBCOLD' --seedmap_path=$seedmap_path
