...
source_path="/gpfs/sharedfs1/zhulab/Jiwon/ARD/"
stack_path="/scratch/suy20004/suy20004/jiwonard"
...
python3 $pycold_path/src/python/pycold/imagetool/prepare_ard.py --source_dir=$source_path --out_dir=$stack_path --rank=$SLURM_ARRAY_TASK_ID --n_cores=$SLURM_ARRAY_TASK_MAX --yaml_path=$yaml_path --collection='ARD-C2'
