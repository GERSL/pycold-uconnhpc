...
#SBATCH --exclude=cn355,cn406,cn217,cn373,cn67,cn354,cn87,cn376,cn68,cn116,cn338,cn330,cn398,cn346,cn364,cn368,cn400,cn329,cn333,cn348,cn356,cn372,cn448,cn343,cn405,cn403,cn404,cn361 
...
seedmap_path="/home/suy20004/lcmap_lc2001/LCMAP_CU_2001_V01_LCPRI_${1}${2}.tif"
pycold_path='/home/suy20004/Document/pycold'

source_path="$data_dir/h${1}v${2}"
stack_path="$working_dir/h${1}v${2}_stack"
result_path="$working_dir/h${1}v${2}_results"
...
python3 $pycold_path/src/python/pycold/imagetool/tile_processing.py --rank=$SLURM_ARRAY_TASK_ID --n_cores=$SLURM_ARRAY_TASK_MAX --result_path=$result_path --stack_path=$stack_path --yaml_path=$yaml_path --method=${3} --seedmap_path=$seedmap_path
